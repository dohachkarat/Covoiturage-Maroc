	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="login.aspx" method="post" class="login100-form validate-form">
					...
					<div class="text-center p-t-46 p-b-20">
						<span class="txt2"><a href="inscription.jsp">
							Vous n'êtes pas encore inscrit? inscrivez-vous ici.</a>
						</span>
					</div>
