              ...
              <div class="col-lg-12">
                ...
                <form id="register-form" action="inscription.aspx" method="post" role="form" style="display: none;">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="prenom" id="prenom" tabindex="1" class="form-control" placeholder="Prénom" value="" required>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="tel">Numéro du téléphone</label>
                    <input type="number" name="tel" id="tel" tabindex="1" class="form-control" placeholder="Numéro du téléphone" value="" required>
                  </div>
                  <div class="form-group">
